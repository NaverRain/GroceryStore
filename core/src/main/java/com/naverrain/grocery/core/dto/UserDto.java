...
public class UserDto {
    ...
    public @NotBlank(message = "Repeat password is required") String getRepeatPassword() {
        return repeatPassword;
    }

    public void setRepeatPassword(@NotBlank(message = "Repeat password is required") String repeatPassword) {
